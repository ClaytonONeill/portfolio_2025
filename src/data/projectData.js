export const projectsData = [
  {
    ...
    description:
      "An application that enables Magic: The Gathering players to build and optimize multiple decks through tools such as CMC and Type metrics, comparable deck versioning, deck objective tracking, and game simulators. This was a personal project built to gain greater familiarity with SupaBase and advanced React context patterns, as well as DaisyUI and site-wide theming. I hope this helps you build your best deck yet!",
    ...
    isPublic: true,
    url: "https://mtgdeckanalyzer.vercel.app/",
  },
  {
    id: 2,
    title: "MDH Environmental Public Health Tracking",
    description:
    ...
    isPublic: true,
    url: "https://maps.health.maryland.gov/ephtportal/",
  },
  {
    id: 3,
    title: "MTA TIGERS",
